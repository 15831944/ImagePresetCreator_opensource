...
protected:
    ...
    bool parseDefs(const QDomElement &root);
    bool parseStyle(const QDomElement &element );
    bool parseChildren(const QDomElement &element, ST_SVG_ELE_COM stEleCom);
    ...
    bool calcBBox();
    void getSubPoints(QSubPointList* pList, const SvgTransform &transform);
    void separationColor(QMap<QString, QSubPointList>& boundarys, QSubPointList* pList);
